...
int main(int argc, char *argv[])
{
  ...
  string onePiAltBinning = inputDir + "/dphitInputs/dphibinning2DPS.txt";
  string disAltBinning = inputDir + "/dphitInputs/dphibinning2DPS.txt";
...
/***********************************************************************************/
  ...
  */
  ...
  effFluxErr->SetBinContent(6, 0.104);
  effFluxErr->SetBinContent(7, 0.094);
  effFluxErr->SetBinContent(8, 0.094);
