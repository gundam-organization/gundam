...
double GeneralSpline::evalGradient(const DialInputBuffer& input_, int iInput_) const {
  ...
  return CalculateGeneralSplineGradient( dialInput, -1E20, 1E20, _splineData_.data(), int(_splineData_.size()) );
}
