...
int main(int argc, char *argv[])
{
  ...
  string fsel     = inputDir + "/datInputs/NeutAir5_2D.root";
  string fakeData     = inputDir + "/datInputs/NeutAir5_2D.root";
  string nomResult;
  string fnameout = "propErrorOut.root";
  string ffluxcov     = inputDir + "/flux_covariance_banff_13av1.1.root";
  string fxsecbinning = inputDir + "/datInputs/datbinning2DPS.txt";
  string fxsecbinning_coarse = inputDir + "/datInputs/datbinning2DPS.txt";
  ...
  string onePiAltBinning = inputDir + "/datInputs/datbinning2DPS.txt";
  string disAltBinning = inputDir + "/datInputs/datbinning2DPS.txt";
  ...
  TFile* CAResrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NXSec_CA5RES_allVariation.root").c_str());
  responsefunctions.push_back(CAResrespfunc);
  TFile* MAResrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NXSec_MaNFFRES_allVariation.root").c_str());
  responsefunctions.push_back(MAResrespfunc);
  TFile* BgResrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NXSec_BgSclRES_allVariation.root").c_str());
  responsefunctions.push_back(BgResrespfunc);
  TFile* CCNuErespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2012a_ccnueE0_allVariation.root").c_str());
  responsefunctions.push_back(CCNuErespfunc);
  TFile* dismpirespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2012a_dismpishp_allVariation.root").c_str());
  responsefunctions.push_back(dismpirespfunc);
  TFile* CCCohrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2012a_cccohE0_allVariation.root").c_str());
  responsefunctions.push_back(CCCohrespfunc);
  TFile* NCCohrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2012a_nccohE0_allVariation.root").c_str());
  responsefunctions.push_back(NCCohrespfunc);
  TFile* NCOthrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2012a_ncotherE0_allVariation.root").c_str());
  responsefunctions.push_back(NCOthrespfunc);
  TFile* EbCrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2014a_Eb_C12_allVariation.root").c_str());
  responsefunctions.push_back(EbCrespfunc);

  // TFile* MAQErespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NXSec_MaCCQE_allVariation.root").c_str());
  // responsefunctions.push_back(MAQErespfunc);
  // TFile* pFrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2014a_pF_C12_allVariation.root").c_str());
  // responsefunctions.push_back(pFrespfunc);
  // TFile* MECrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWGMEC_Norm_C12_allVariation.root").c_str());
  // responsefunctions.push_back(MECrespfunc);

  TFile* MAQErespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NXSec_MaCCQE_allVariation.rootDummy").c_str());
  responsefunctions.push_back(MAQErespfunc);
  TFile* pFrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWG2014a_pF_C12_allVariation.rootDummy").c_str());
  responsefunctions.push_back(pFrespfunc);
  TFile* MECrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NIWGMEC_Norm_C12_allVariation.rootDummy").c_str());
  responsefunctions.push_back(MECrespfunc);
  ...
  TFile* FrInelLowrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrCExLow_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrInelLowrespfunc);
  TFile* FrInelHighrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrInelHigh_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrInelHighrespfunc);
  TFile* FrPiProdrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrPiProd_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrPiProdrespfunc);
  TFile* FrAbsrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrAbs_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrAbsrespfunc);
  TFile* FrCExLowrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrCExLow_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrCExLowrespfunc);
  TFile* FrCExHighrespfunc = new TFile((inputDir + "/datInputs/responsefuncSD/NCasc_FrInelHigh_pi_allVariation.root").c_str());
  ...
  */
  ...
  //Det parameters
  DetParameters detpara((inputDir + "/datInputs/datbinning2DPS.txt").c_str(), det_weights, samples, "par_detAve");
  detpara.InitEventMap(samples, 0);
  if(USESYST==1 || USESYST==3) fitpara.push_back(&detpara);
  else detpara.SetNpar(0);

  DetParameters detpara_fine((inputDir + "/datInputs/datbinning2DPS_covMatCoarse.txt").c_str(),det_weights_fine, samples, "par_detFine");
  ...
  for(int p=0; p<priorVec->GetNrows(); p++){
    ...
    if(p<83){
      ...
      prefitParams_red->SetBinContent(p+1, prefitParams->GetBinContent(p+4));
      prefitParams_red->SetBinError(p+1, prefitParams->GetBinError(p+4));
    }
  }
  ...
  effFluxErr->SetBinContent(1, 0.088);
  effFluxErr->SetBinContent(2, 0.088);
  effFluxErr->SetBinContent(3, 0.088);
  effFluxErr->SetBinContent(4, 0.088);
  effFluxErr->SetBinContent(5, 0.088);
  effFluxErr->SetBinContent(6, 0.086);
  effFluxErr->SetBinContent(7, 0.086);
  effFluxErr->SetBinContent(8, 0.086);
