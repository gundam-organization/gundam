...
int main(int argc, char *argv[])
{
  ...
  string fsel     = inputDir + "/dphitInputs/NeutAir5_2D.root";
  //string fakeData     = inputDir + "/GenieAir2_2DV2.root";
  string fakeData     = inputDir + "/dphitInputs/NeutAir5_2D.root";
  string ffluxcov     = inputDir + "/flux_covariance_banff_13av1.1.root";
  string fdetcov_fine = inputDir + "/dphitInputs/dphitCovMat500Toys.root";
  //string fdetcov = inputDir + "/dphitInputs/dphitCovMat500Toys.root";
  string fdetcov = inputDir + "/newFitsFeb17/dpt/covMatFromParaOut.root";
  string fxsecbinning = inputDir + "/dphitInputs/dphitbinning2DPS.txt";
  string fxsecbinning_coarse = inputDir + "/dphitInputs/dphitbinning2DPS.txt";
  string fnameout = "fitresults.root";
  string paramVectorFname = "fitresults.root";

  //Optional binnings to improve GoF in sidebands: 
  string onePiAltBinning = inputDir + "/dphitInputs/dphitbinning2DPS.txt";
  string disAltBinning = inputDir + "/dphitInputs/dphitbinning2DPS.txt";
  ...
  TMatrixDSym *cov_det_now   = (TMatrixDSym*)findetcov->Get("covMat_mean_norm");
  ...
  TFile* CAResrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NXSec_CA5RES_allVariation.root").c_str());
  responsefunctions.push_back(CAResrespfunc);
  TFile* MAResrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NXSec_MaNFFRES_allVariation.root").c_str());
  responsefunctions.push_back(MAResrespfunc);
  TFile* BgResrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NXSec_BgSclRES_allVariation.root").c_str());
  responsefunctions.push_back(BgResrespfunc);
  TFile* CCNuErespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2012a_ccnueE0_allVariation.root").c_str());
  responsefunctions.push_back(CCNuErespfunc);
  TFile* dismpirespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2012a_dismpishp_allVariation.root").c_str());
  responsefunctions.push_back(dismpirespfunc);
  TFile* CCCohrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2012a_cccohE0_allVariation.root").c_str());
  responsefunctions.push_back(CCCohrespfunc);
  TFile* NCCohrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2012a_nccohE0_allVariation.root").c_str());
  responsefunctions.push_back(NCCohrespfunc);
  TFile* NCOthrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2012a_ncotherE0_allVariation.root").c_str());
  responsefunctions.push_back(NCOthrespfunc);
  TFile* EbCrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2014a_Eb_C12_allVariation.root").c_str());
  ...
  if(templateFit!=1){ // If fitting model params use CCQE params, if using tempalte fit use dummy params
    TFile* MAQErespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NXSec_MaCCQE_allVariation.root").c_str());
    responsefunctions.push_back(MAQErespfunc);
    TFile* pFrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2014a_pF_C12_allVariation.root").c_str());
    responsefunctions.push_back(pFrespfunc);
    TFile* MECrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWGMEC_Norm_C12_allVariation.root").c_str());
    responsefunctions.push_back(MECrespfunc);
  }
  else{
    TFile* MAQErespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NXSec_MaCCQE_allVariation.rootDummy").c_str());
    responsefunctions.push_back(MAQErespfunc);
    TFile* pFrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWG2014a_pF_C12_allVariation.rootDummy").c_str());
    responsefunctions.push_back(pFrespfunc);
    TFile* MECrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NIWGMEC_Norm_C12_allVariation.rootDummy").c_str());
    responsefunctions.push_back(MECrespfunc);
  }
  ...
  TFile* FrInelLowrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrCExLow_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrInelLowrespfunc);
  TFile* FrInelHighrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrInelHigh_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrInelHighrespfunc);
  TFile* FrPiProdrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrPiProd_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrPiProdrespfunc);
  TFile* FrAbsrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrAbs_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrAbsrespfunc);
  TFile* FrCExLowrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrCExLow_pi_allVariation.root").c_str());
  responsefunctions_FSI.push_back(FrCExLowrespfunc);
  TFile* FrCExHighrespfunc = new TFile((inputDir + "/dphitInputs/responsefuncSD/NCasc_FrInelHigh_pi_allVariation.root").c_str());
  ...
  */
  ...
  fluxpara.SetCovarianceMatrix(&cov_flux);
  fluxpara.InitEventMap(samples, pmode);
  if(USESYST==1 || USESYST==2) fitpara.push_back(&fluxpara);


  //Det parameters
  DetParameters detpara((inputDir + "/dphitInputs/dphitbinning2DPS.txt").c_str(), det_weights, samples, "par_detAve");
  detpara.SetCovarianceMatrix(&cov_det);
  detpara.InitEventMap(samples, pmode);
  if(USESYST==1 || USESYST==3) fitpara.push_back(&detpara);


  // DetParameters detpara_fine((inputDir + "/dphitInputs/dphitbinning2DPS_covMatCoarse.txt").c_str(),det_weights_fine, samples, "par_detFine");
