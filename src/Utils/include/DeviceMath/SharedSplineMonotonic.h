...
namespace GundamDeviceMath {
  ...
  GUNDAM_DEVICE_MATH_SCALAR EvaluateMonotonicSpline(const GUNDAM_DEVICE_MATH_SCALAR x_,
    ...
    GUNDAM_DEVICE_MATH_SCALAR m2 = GUNDAM_DEVICE_MATH_SCALAR(0.5) * (d21 + d32);
    GUNDAM_DEVICE_MATH_SCALAR m3 = GUNDAM_DEVICE_MATH_SCALAR(0.5) * (d32 + d43);
    ...
    if( d32 * d21 <= GUNDAM_DEVICE_MATH_SCALAR(0.0) ){ m2 = GUNDAM_DEVICE_MATH_SCALAR(0.0); }
    if( d43 * d32 <= GUNDAM_DEVICE_MATH_SCALAR(0.0) ){ m3 = GUNDAM_DEVICE_MATH_SCALAR(0.0); }

    const GUNDAM_DEVICE_MATH_SCALAR ad21 = Abs(d21);
    const GUNDAM_DEVICE_MATH_SCALAR ad32 = Abs(d32);
    const GUNDAM_DEVICE_MATH_SCALAR ad43 = Abs(d43);
    const GUNDAM_DEVICE_MATH_SCALAR delta2 = GUNDAM_DEVICE_MATH_SCALAR(3.0) * Min(ad21, ad32);
    const GUNDAM_DEVICE_MATH_SCALAR delta3 = GUNDAM_DEVICE_MATH_SCALAR(3.0) * Min(ad32, ad43);
