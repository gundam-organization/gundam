...
void genResponse_dpt(string microtreeIn, string rwpath, string dialName, double nom, double err, int topo, int reac, int dataType=0) {
  ...
  */
  ...
  for(const int bt = 0; bt < nTbins; bt++){
    ...
    cout << "Current bins (global dpt): " << globalCount << " " << bt << endl << endl;
