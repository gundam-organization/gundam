                ...
                TString D2NameRec, TString D2NameTrue, TString D2NameTrue_T, bool isRealData=false, bool psdim=true, bool useAltPp=false)
{
  ...
  for (Long64_t jentry=0; jentry<nentries_T;jentry++) {
    ...
    if(specialRWmode==5 && pMomTrue_T>500 && pMomTrue_T<700 && muCosThetaTrue_T<0.7) weight_T=1.5;
    if(specialRWmode==6 && pMomTrue_T>500 && pMomTrue_T<700 && muCosThetaTrue_T<0.7) weight_T=0.5;
    outtree_T->Fill();
  }
