...
if [ $1 == 'test' ]; then
	mkdir job_${1}_${var}
	cp genResponse_${var}.C ./job_${1}_${var}
	cd job_${1}_${var}
	#for topo in 1 2 3 5 6 7 8 9; do
	#  for reac in 0 1 2 3 4 5 7; do
	for topo in 1; do
	  for reac in 1; do
cat <<EOF > test_T${topo}R${reac}.sh 	
#!/bin/sh
source /home/dolan/.bashrc
runxstoolmar16v1r5
ulimit -n 4096
cd /data/t2k/dolan/fitting/genResp_output
mkdir ${var}
cd ${var}	
mkdir testrun
cd testrun
mkdir output
ln -s /data/t2k/dolan/software/xsLLhFitter/xsLLhFitter/macros/genResponse_${var}.C .
echo "Processing testrun mode on topo ${topo} and reac ${reac}"
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NXSec_MaCCQE\"       ,0.95,0.14,${topo},${reac})" > /dev/null
EOF
qsub test_T${topo}R${reac}.sh
	  done
	done
fi
...
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NXSec_MaCCQE\"       ,0.95,0.14,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2014a_pF_C12\"   ,1.03,0.15,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWGMEC_Norm_C12\"   ,0.27,0.73,${topo},${reac})" > /dev/null
# Ignore Oxygen Params for the moment
#root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2014a_pF_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
#root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWGMEC_Norm_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
#root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2014a_Eb_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
EOF
...
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NXSec_CA5RES\"       ,1.00,0.12,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NXSec_MaNFFRES\"     ,1.00,0.16,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NXSec_BgSclRES\"     ,1.00,0.15,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2012a_ccnueE0\"  ,1.00,0.02,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2012a_dismpishp\",1.00,0.40,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2012a_cccohE0\"  ,1.00,1.00,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2012a_nccohE0\"  ,1.00,0.30,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2012a_ncotherE0\",1.00,0.30,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NIWG2014a_Eb_C12\"   ,1.00,0.36,${topo},${reac})" > /dev/null
EOF
...
ln -s /data/t2k/dolan/software/xsLLhFitter/xsLLhFitter/macros/genResponse_${var}.C .
echo "Processing xsToolXsBkg mode on topo ${topo} and reac ${reac}"
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrInelHigh_pi\",1.00,0.33,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrInelLow_pi\" ,1.00,0.41,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrPiProd_pi\"  ,1.00,0.50,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrAbs_pi\"     ,1.00,0.41,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrCExLow_pi\"  ,1.00,0.57,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_${var}.C(\"${mt}\",\"${wd}\",\"NCasc_FrCExHigh_pi\" ,1.00,0.28,${topo},${reac})" > /dev/null
EOF
...
root -b -q -l "genResponse_${var}.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
