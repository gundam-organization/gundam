...
int plotReco(TString inFilenameMC, TString inFilenameData, TString outFileName, TString varName="dpt", Float_t potRatio=1.0 /*0.2015*/, bool useFineBins=true,  bool scaleByBinWidth=true, bool weightMatching=false)
{
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    if((mectopology==0 || mectopology==2)){

      if     (reaction==0) allSelBranchCompCC0Pi1PMC->Fill(cutBranchConv+0.5, weight); 
      else if(reaction==9) allSelBranchCompCC0PiNPMC->Fill(cutBranchConv+0.5, weight); 
      else if(reaction==1) allSelBranchCompCC1PiMC->Fill(cutBranchConv+0.5, weight); 
      else if(reaction==2) allSelBranchCompCCOtherMC->Fill(cutBranchConv+0.5, weight); 
      else                 allSelBranchCompOthMC->Fill(cutBranchConv+0.5, weight); 

      //Fill STV
      if(isSigBranch0piNp && D2Rec==0 && isSTVIPS){
        if(reaction==0)       stvCC0piNpIPS->Fill(D1True, weight);
        else if(reaction==9)  stvCC0piNpOOPS->Fill(D1True, weight);
        else if(reaction==1)  stvCC1pi->Fill(D1True, weight);
        else if(reaction==2)  stvCCOther->Fill(D1True, weight);
        else                  stvOther->Fill(D1True, weight);
      }

      //Fill infpMMomDif
      if(isSigBranch0piNp && pMomRec>450.0 && pCosThetaRec>0.4 && isIfkIPS){
        if(reaction==0)       infpMMomDifCC0piNpIPS->Fill(infpMMomDif, weight);
        else if(reaction==9)  infpMMomDifCC0piNpOOPS->Fill(infpMMomDif, weight);
        else if(reaction==1)  infpMMomDifCC1pi->Fill(infpMMomDif, weight);
        else if(reaction==2)  infpMMomDifCCOther->Fill(infpMMomDif, weight);
        else                  infpMMomDifOther->Fill(infpMMomDif, weight);
      }

      //Fill infpAnglDif
      if(isSigBranch0piNp && pMomRec>450.0 && pCosThetaRec>0.4){
        if(reaction==0)       infpAnglDifCC0piNpIPS->Fill(infpAnglDif, weight);
        else if(reaction==9)  infpAnglDifCC0piNpOOPS->Fill(infpAnglDif, weight);
        else if(reaction==1)  infpAnglDifCC1pi->Fill(infpAnglDif, weight);
        else if(reaction==2)  infpAnglDifCCOther->Fill(infpAnglDif, weight);
        else                  infpAnglDifOther->Fill(infpAnglDif, weight);
      }

      //Fill infp3MomDif
      if(isSigBranch0piNp && pMomRec>450.0 && pCosThetaRec>0.4){
        if(reaction==0)       infp3MomDifCC0piNpIPS->Fill(infp3MomDif, weight);
        else if(reaction==9)  infp3MomDifCC0piNpOOPS->Fill(infp3MomDif, weight);
        else if(reaction==1)  infp3MomDifCC1pi->Fill(infp3MomDif, weight);
        else if(reaction==2)  infp3MomDifCCOther->Fill(infp3MomDif, weight);
      ...
      if(isSigBranch0pi){
        if(reaction==0)       mommuCC0piNpIPS->Fill(muMomTrue, weight);
        else if(reaction==9)  mommuCC0piNpOOPS->Fill(muMomTrue, weight);
        else if(reaction==1)  mommuCC1pi->Fill(muMomTrue, weight);
        else if(reaction==2)  mommuCCOther->Fill(muMomTrue, weight);
        else                  mommuOther->Fill(muMomTrue, weight);
      }
      else if (is1piCRBranch){
        if(reaction==0)       mommuCC0piNpIPS_1pi->Fill(muMomTrue, weight);
        else if(reaction==9)  mommuCC0piNpOOPS_1pi->Fill(muMomTrue, weight);
        else if(reaction==1)  mommuCC1pi_1pi->Fill(muMomTrue, weight);
        else if(reaction==2)  mommuCCOther_1pi->Fill(muMomTrue, weight);
        else                  mommuOther_1pi->Fill(muMomTrue, weight);
        mommuTotal_1pi->Fill(muMomTrue, weight);
      }
      else if (isdisCRBranch){
        if(reaction==0)       mommuCC0piNpIPS_dis->Fill(muMomTrue, weight);
        else if(reaction==9)  mommuCC0piNpOOPS_dis->Fill(muMomTrue, weight);
        else if(reaction==1)  mommuCC1pi_dis->Fill(muMomTrue, weight);
        else if(reaction==2)  mommuCCOther_dis->Fill(muMomTrue, weight);
        else                  mommuOther_dis->Fill(muMomTrue, weight);
        mommuTotal_dis->Fill(muMomTrue, weight);
      }

      //Fill cthmu
    
      if(isSigBranch0pi){
        if(reaction==0)       cthmuCC0piNpIPS->Fill(muCosThetaTrue, weight);
        else if(reaction==9)  cthmuCC0piNpOOPS->Fill(muCosThetaTrue, weight);
        else if(reaction==1)  cthmuCC1pi->Fill(muCosThetaTrue, weight);
        else if(reaction==2)  cthmuCCOther->Fill(muCosThetaTrue, weight);
        else                  cthmuOther->Fill(muCosThetaTrue, weight);
      }
      else if(is1piCRBranch){
        if(reaction==0)       cthmuCC0piNpIPS_1pi->Fill(muCosThetaTrue, weight);
        else if(reaction==9)  cthmuCC0piNpOOPS_1pi->Fill(muCosThetaTrue, weight);
        else if(reaction==1)  cthmuCC1pi_1pi->Fill(muCosThetaTrue, weight);
        else if(reaction==2)  cthmuCCOther_1pi->Fill(muCosThetaTrue, weight);
        else                  cthmuOther_1pi->Fill(muCosThetaTrue, weight);
        cthmuTotal_1pi->Fill(muCosThetaTrue, weight);
      }
      else if(isdisCRBranch){
        if(reaction==0)       cthmuCC0piNpIPS_dis->Fill(muCosThetaTrue, weight);
        else if(reaction==9)  cthmuCC0piNpOOPS_dis->Fill(muCosThetaTrue, weight);
        else if(reaction==1)  cthmuCC1pi_dis->Fill(muCosThetaTrue, weight);
        else if(reaction==2)  cthmuCCOther_dis->Fill(muCosThetaTrue, weight);
        else                  cthmuOther_dis->Fill(muCosThetaTrue, weight);
        cthmuTotal_dis->Fill(muCosThetaTrue, weight);
      }

      //Fill pp

      if(isSigBranch0piNp){
        if(reaction==0)       momprCC0piNpIPS->Fill(pMomTrue, weight);
        else if(reaction==9)  momprCC0piNpOOPS->Fill(pMomTrue, weight);
        else if(reaction==1)  momprCC1pi->Fill(pMomTrue, weight);
        else if(reaction==2)  momprCCOther->Fill(pMomTrue, weight);
        else                  momprOther->Fill(pMomTrue, weight);
      }
      else if(is1piCRBranch){
        if(reaction==0)       momprCC0piNpIPS_1pi->Fill(hmpMomTrue, weight);
        else if(reaction==9)  momprCC0piNpOOPS_1pi->Fill(hmpMomTrue, weight);
        else if(reaction==1)  momprCC1pi_1pi->Fill(hmpMomTrue, weight);
        else if(reaction==2)  momprCCOther_1pi->Fill(hmpMomTrue, weight);
        else                  momprOther_1pi->Fill(hmpMomTrue, weight);
        momprTotal_1pi->Fill(hmpMomTrue, weight);
      }
      else if(isdisCRBranch){
        if(reaction==0)       momprCC0piNpIPS_dis->Fill(hmpMomTrue, weight);
        else if(reaction==9)  momprCC0piNpOOPS_dis->Fill(hmpMomTrue, weight);
        else if(reaction==1)  momprCC1pi_dis->Fill(hmpMomTrue, weight);
        else if(reaction==2)  momprCCOther_dis->Fill(hmpMomTrue, weight);
        else                  momprOther_dis->Fill(hmpMomTrue, weight);
        momprTotal_dis->Fill(hmpMomTrue, weight);
      }

      //Fill cthp
    
      if(isSigBranch0piNp && pMomRec>500){
        if(reaction==0)       cthprCC0piNpIPS->Fill(pCosThetaTrue, weight);
        else if(reaction==9)  cthprCC0piNpOOPS->Fill(pCosThetaTrue, weight);
        else if(reaction==1)  cthprCC1pi->Fill(pCosThetaTrue, weight);
        else if(reaction==2)  cthprCCOther->Fill(pCosThetaTrue, weight);
        else                  cthprOther->Fill(pCosThetaTrue, weight);
      }
      else if(is1piCRBranch) {
        if(reaction==0)       cthprCC0piNpIPS_1pi->Fill(hmpCosThetaTrue, weight);
        else if(reaction==9)  cthprCC0piNpOOPS_1pi->Fill(hmpCosThetaTrue, weight);
        else if(reaction==1)  cthprCC1pi_1pi->Fill(hmpCosThetaTrue, weight);
        else if(reaction==2)  cthprCCOther_1pi->Fill(hmpCosThetaTrue, weight);
        else                  cthprOther_1pi->Fill(hmpCosThetaTrue, weight);    
        cthprTotal_1pi->Fill(hmpCosThetaTrue, weight);
      }
      else if(isdisCRBranch) {
        if(reaction==0)       cthprCC0piNpIPS_dis->Fill(hmpCosThetaTrue, weight);
        else if(reaction==9)  cthprCC0piNpOOPS_dis->Fill(hmpCosThetaTrue, weight);
        else if(reaction==1)  cthprCC1pi_dis->Fill(hmpCosThetaTrue, weight);
        else if(reaction==2)  cthprCCOther_dis->Fill(hmpCosThetaTrue, weight);
        else                  cthprOther_dis->Fill(hmpCosThetaTrue, weight);  
        cthprTotal_dis->Fill(hmpCosThetaTrue, weight);
      }
    }
  }
  ...
  TopoLeg->AddEntry(stvCC0piNpIPS,"CCQE","lf");
  TopoLeg->AddEntry(stvCC0piNpOOPS,"2p2h","lf");
  TopoLeg->AddEntry(stvCC1pi,"RES","lf");
  TopoLeg->AddEntry(stvCCOther,"DIS","lf");
  ...
  TopoLegBr->AddEntry(allSelBranchCompCC0Pi1PMC,"CCQE","lf");
  TopoLegBr->AddEntry(allSelBranchCompCC0PiNPMC,"2p2h","lf");
  TopoLegBr->AddEntry(allSelBranchCompCC1PiMC,"RES","lf");
  TopoLegBr->AddEntry(allSelBranchCompCCOtherMC,"DIS","lf");
  ...
  TopoLegCth->AddEntry(stvCC0piNpIPS,"CCQE","lf");
  TopoLegCth->AddEntry(stvCC0piNpOOPS,"2p2h","lf");
  TopoLegCth->AddEntry(stvCC1pi,"RES","lf");
  TopoLegCth->AddEntry(stvCCOther,"DIS","lf");
  ...
  TopoLeg_md->AddEntry(stvCC0piNpIPS,"CCQE","lf");
  TopoLeg_md->AddEntry(stvCC0piNpOOPS,"2p2h","lf");
  TopoLeg_md->AddEntry(stvCC1pi,"RES","lf");
  TopoLeg_md->AddEntry(stvCCOther,"DIS","lf");
  ...
  TopoLegCth_md->AddEntry(stvCC0piNpIPS,"CCQE","lf");
  TopoLegCth_md->AddEntry(stvCC0piNpOOPS,"2p2h","lf");
  TopoLegCth_md->AddEntry(stvCC1pi,"RES","lf");
  TopoLegCth_md->AddEntry(stvCCOther,"DIS","lf");
  ...
  canv_allSelBranchComp->SaveAs("allSelBranchComp.png");
  ...
  canv_stvTopo->Write();
  if(varName=="dpt") { canv_stvTopo->SaveAs("dptTopo.pdf"); canv_stvTopo->SaveAs("dptTopo.png"); }
  else if((varName=="dphiT" || varName=="dphit")) { canv_stvTopo->SaveAs("dphitTopo.pdf"); canv_stvTopo->SaveAs("dphitTopo.png"); }
  else if((varName=="dalphaT" || varName=="dalphat" || varName=="dat")) { canv_stvTopo->SaveAs("datTopo.pdf"); canv_stvTopo->SaveAs("datTopo.png"); }


  //infpMMomDif
  TCanvas* canv_infpMMomDifTopo = new TCanvas("canv_infpMMomDifTopo","canv_infpMMomDifTopo",1920,1080);
  infpMMomDifData->Draw("AXIS");
  ...
  canv_infpMMomDifTopo->SaveAs("infpMMomDifTopo.png");
  ...
  canv_infpAnglDifTopo->SaveAs("infpAnglDifTopo.png");
  ...
  canv_infp3MomDifTopo->SaveAs("infp3MomDifTopo.png");
 ...
 // mommuData->Draw("sameE1");
  ...
  canv_mommuTopo->SaveAs("mommuTopo.png");
  ...
  canv_cthmuTopo->SaveAs("cthmuTopo.png");
  ...
  canv_momprTopo->SaveAs("momprTopo.png");
  ...
  canv_cthprTopo->SaveAs("cthprTopo.png");
  ...
  canv_mommuTopo_1pi->SaveAs("mommuTopo_1pi.png");
  ...
  canv_cthmuTopo_1pi->SaveAs("cthmuTopo_1pi.png");
  ...
  canv_momprTopo_1pi->SaveAs("momprTopo_1pi.png");
  ...
  canv_cthprTopo_1pi->SaveAs("cthprTopo_1pi.png");
  ...
  canv_mommuTopo_dis->SaveAs("mommuTopo_dis.png");
  ...
  canv_cthmuTopo_dis->SaveAs("cthmuTopo_dis.png");
  ...
  canv_momprTopo_dis->SaveAs("momprTopo_dis.png");
  ...
  canv_cthprTopo_dis->SaveAs("cthprTopo_dis.png");
  ...
  if(makeFinalWM && !useFineBins){
    ...
    TopoLeg_WM->AddEntry(stvCC1pi,"RES","lf");
    TopoLeg_WM->AddEntry(stvCCOther,"DIS","lf");
    ...
    TopoLegCth_WM->AddEntry(stvCC1pi,"RES","lf");
    TopoLegCth_WM->AddEntry(stvCCOther,"DIS","lf");
