...
int main() {
    ...
    std::shared_ptr<TFile> mcmc(new TFile("200NormalizationMCMCFixed.root","old"));
    ...
    TH1F positiveC("positiveC", "positiveC",100, 0.0, 1.0);
    TH1F negativeC("negativeC", "negativeC",100, 0.0, 1.0);
    TH1F dummyA("dummyA",       "dummyA fixed",100, 0.5, 1.5);
    tree->SetBranchAddress("Points",&addrPoints);
    for (int i=0; i < tree->GetEntries(); ++i) {
        tree->GetEntry(i);
        positiveC.Fill(points[0]);
        negativeC.Fill(points[1]);
        dummyA.Fill(points[2]);
    }

    positiveC.Draw();
    gPad->Print("900NormalizationMCMCFixedCheck.pdf(");
    negativeC.Draw();
    gPad->Print("900NormalizationMCMCFixedCheck.pdf");
    dummyA.Draw();
    gPad->Print("900NormalizationMCMCFixedCheck.pdf)");
    ...
    TOLERANCE("Check fixed parameter #2_Dummy_A RMS",
              dummyA.GetRMS(),
              0.0,1.0E-6)
