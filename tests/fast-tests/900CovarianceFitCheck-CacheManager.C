...
int main() {
    ...
    TOLERANCE("Check HESSE value for #0_norm_A",
              postFitErrorsHesse->GetBinContent(1), 1.00897632e+00, tolerance);
    TOLERANCE("Check variance for #0_norm_A",
              (*covariance)(0,0), 1.45851039e-04, tolerance);

    TOLERANCE("Check HESSE value for #1_norm_B",
              postFitErrorsHesse->GetBinContent(2), 9.72593603e-01, tolerance);
    TOLERANCE("Check variance for #1_norm_B",
              (*covariance)(1,1), 1.42621215e-04, tolerance);

    TOLERANCE("Check HESSE value for #2_spline_C",
              postFitErrorsHesse->GetBinContent(3), -5.81919208e-03, tolerance);
    TOLERANCE("Check variance for #2_spline_C",
              (*covariance)(2,2), 1.22805697e-05, tolerance);

    TOLERANCE("Check HESSE value for #3_spline_D",
              postFitErrorsHesse->GetBinContent(4), 6.75146675e-04, tolerance);
    TOLERANCE("Check variance for #3_spline_D",
              (*covariance)(3,3), 2.21879306e-05, tolerance);
