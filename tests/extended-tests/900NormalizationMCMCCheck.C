...
int main() {
    ...
    // sample size factor of 10 (i.e. it takes about 10 steps to become
    ...
    TOLERANCE("Check MCMC matches HESSE value for #0_Positive_C",
              positiveC.GetMean(),
              postFitErrorsHesse->GetBinContent(1), 3*relativeSigma);
    TOLERANCE("Check MCMC matches HESSE value for #0_Positive_C",
              positiveC.GetRMS(),
              postFitErrorsHesse->GetBinError(1), 3*relativeSigma);
    TOLERANCE("Check MCMC RMS matches HESSE value for #1_Negative_C",
              negativeC.GetMean(),
              postFitErrorsHesse->GetBinContent(2), 3*relativeSigma);
    TOLERANCE("Check MCMC RMS matches HESSE value for #1_Negative_C",
              negativeC.GetRMS(),
              postFitErrorsHesse->GetBinError(2), 3*relativeSigma);
