...
TEST(CompactSpline,LinearInterpolation) {
    ...
    for (double x = -1.0; x <= 2.0; x += 0.1) {
        ...
        EXPECT_NEAR(x, v, 1E-6) << "Two Point Tolerance is too large";
