...
int main() {
    ...
    TOLERANCE("Check HESSE value for #0_Positive_C",
              postFitErrorsHesse->GetBinContent(1), 7.94617953e-01, valueTolerance);
    TOLERANCE("Check MIGRAD value matches HESSE value for #0_Positive_C",
              postFitErrorsMigrad->GetBinContent(1),
              postFitErrorsHesse->GetBinContent(1), valueTolerance);

    TOLERANCE("Check HESSE variance for #0_Positive_C",
              (*covariance)(0,0), 1.10088277e-04, varianceTolerance);

    TOLERANCE("Check HESSE value for #1_Negative_C",
              postFitErrorsHesse->GetBinContent(2), 5.89778071e-01, valueTolerance);
    TOLERANCE("Check MIGRAD value matches HESSE value for #1_Negative_C",
              postFitErrorsMigrad->GetBinContent(2),
               postFitErrorsHesse->GetBinContent(2), valueTolerance);

    TOLERANCE("Check variance for #1_Negative_C",
              (*covariance)(1,1), 8.96042904e-05, varianceTolerance);
    TOLERANCE("Check covariance",
              (*covariance)(0,1), -3.06264806e-05, varianceTolerance);
