...
////////////////////////////////////////////////////////////////////////
// Test the CalculateCompactInterpolation routine on the CPU.

#include "${GUNDAM_ROOT}/src/Utils/include/CalculateBilinearInterpolation.h"
...
#define TEST2
#ifdef TEST2
    {
        ...
        graph1->Draw("colz");
        gPad->Print("100CheckBilinear2.pdf");
        gPad->Print("100CheckBilinear2.png");
    }
#endif
...
#define TEST3
#ifdef TEST3
    {
        ...
        graph1->Draw("AC");
        gPad->Print("100CheckBilinear3.pdf");
        gPad->Print("100CheckBilinear3.png");
    }
#endif
